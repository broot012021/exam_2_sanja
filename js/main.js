$(document).ready(function () {
  ...
  $(".block1__btn")
    .find("p")
    .click(function () {
      const src = $(".block1").find("img:first-child").attr("src");
      const subtitle = $(".block1__subtitle").find("h4").text();
      const title = $(".block1__title").find("h3").text();
      const text = $(".block1__text").find("p").text();
  ...
  $(".block2__btn")
    .find("p")
    .click(function () {
      const src = $(".block2").find("img:first-child").attr("src");
      const subtitle = $(".block2__subtitle").find("h4").text();
      const title = $(".block2__title").find("h3").text();
      const text = $(".block2__text").find("p").text();
  ...
  $(".gallery__card").click(function () {
    ...
    $(".gallery__holder").find("img").attr("src", src);
